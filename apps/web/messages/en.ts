const en = {
  ...
  screen: {
    ...
    config: {
      ...
      minDte: "Min DTE",
      maxDte: "Max DTE",
      minNetPremium: "Min net premium ($/share)",
      minNetPremiumHint: "Per-share USD, not per contract",
      minAnnualized: "Min annualized return",
      ratioHint: "Enter as a decimal (0.10 = 10%)",
      minIvRv: "Min IV / RV",
      minIvMinusRv: "Min IV − RV",
      maxSpread: "Max spread ratio",
      putRecall: "Put recall below spot",
      callRecall: "Call recall above floor",
      callCostFloor: "Call cost floor multiplier",
      earningsWindow: "Earnings hard window (days)",
      proximityBand: "Return proximity band",
      feePerContract: "Fee per contract (USD)",
      feeHint: "Amortized to $/share by ÷100",
    },
    saveConfig: "Save parameters",
    saving: "Saving…",
    empty: "No candidates yet. Adjust parameters and run a scan.",
    emptyAfterScan: "No contracts passed your filters for this side. Try loosening thresholds.",
