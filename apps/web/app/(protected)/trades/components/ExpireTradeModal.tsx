      ...
      <div className="w-full max-w-lg rounded-2xl bg-white shadow-xl">
        <div className="flex items-start justify-between">
          <div className="border-b border-gray-200 px-6 py-4">
            <h2 className="text-base font-semibold text-gray-900">Mark as Expired</h2>
          ...
          <button
            type="button"
            onClick={onClose}
            className="m-4 rounded-lg p-1 text-gray-400 hover:text-gray-600"
            aria-label="Close"
          >
            ✕
          </button>
        ...
        <div className="rounded-xl border border-gray-200 p-4">
          ...
          <div className="mt-4 grid grid-cols-3 gap-3">
            <div className="rounded-xl border border-gray-200 p-3">
              ...
              <p className="mt-1 text-lg font-semibold text-gray-900">${trade.strike.toFixed(2)}</p>
            </div>
            <div className="rounded-xl border border-gray-200 p-3">
        ...
        <div className="mt-5">
          <label htmlFor="expire_action_date" className="mb-1 block text-sm font-medium text-gray-700">
            Action Date
          </label>
          <input
        ...
        <div className="mt-6 flex justify-end gap-3">
          ...
          >
            {isSubmitting ? "Saving..." : "Mark Expired"}
          </button>
        </div>
        </div>
      </div>
