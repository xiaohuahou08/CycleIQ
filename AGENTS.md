...
- Landing/login/register pages render without Supabase. **Authenticated flows (dashboard, trades, cycles, screen) require real Supabase env**; middleware redirects protected routes to `/login` when session cookies are missing.
